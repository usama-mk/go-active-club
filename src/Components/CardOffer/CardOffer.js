        ...
        <div className="cardOffer"  >
            ...
            <div className="cardOffer__moreInfo">
                <div className="cardOffer__moreInfo__aboutOffer">
                    ...
                    <div onClick={handleIndividualOffer} className="cardOffer__moreInfo__aboutOffer__button">
                        See Offer
                    </div>
                </div>

                <div onClick={handleParticipants} className="cardOffer__moreInfo__otherParticipants" >
